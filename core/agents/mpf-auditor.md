...
- **Route/endpoint existence:** Use `text_search` for route definitions, URL patterns, API paths matching the requirement domain (e.g., `/api/users`, `@app.route`, `router.get`).
